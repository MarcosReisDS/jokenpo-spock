...
import "../Rules/style/index.css"


interface IRules {
    exit?: () => void;
}
const Rules: FC<IRules> = ({ exit }) => {
    return (
        <div className="container-rules">
            <div className="painting-rules">
                <div className="exit-rules">
                    <p>REGRAS</p>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" style={{ cursor: "pointer" }} onClick={exit}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="350" height="330">
                    <defs>
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <text xmlns="http://www.w3.org/2000/svg" fill="#B1B4C5" font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="11" font-style="condensed" font-weight="bold">
                            <tspan x="300" y="85">PAPEL</tspan>
                        </text>
                        <text xmlns="http://www.w3.org/2000/svg" fill="#B1B4C5" font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="11" font-style="condensed" font-weight="bold">
                            <tspan x="285" y="329">PEDRA</tspan>
                        </text>
                        <text xmlns="http://www.w3.org/2000/svg" fill="#B1B4C5" font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="11" font-style="condensed" font-weight="bold">
                            <tspan x="0" y="85">SPOCK</tspan>
                        </text>
                        <text xmlns="http://www.w3.org/2000/svg" fill="#B1B4C5" font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="11" font-style="condensed" font-weight="bold">
                            <tspan x="0" y="329">LAGARTO</tspan>
                        </text>
                    </g>
                </svg>
                <p className="tesoura">TESOURA</p>
                <p className="condicoes">OS INDICADORES MOSTRAM, VITÓRIA E DERROTA</p>
            </div>
        </div>
    )
}
